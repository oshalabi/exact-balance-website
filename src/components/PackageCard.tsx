        ...
        <ul className="space-y-3 mb-8 flex-grow">
          ...
          <li className="flex items-start">
            ...
            <div className={pkg.popular ? 'text-white' : 'text-gray-300'}>
              <span className="text-sm">Aangifte inkomstenbelasting</span>
          ...
          <li className="flex items-start">
            ...
            <span className={pkg.popular ? 'text-white text-sm' : 'text-gray-300 text-sm'}>
              Uitleg gebruik online boekhoudpakket
            </span>
          </li>
          ...
          <li className="flex items-start">
            ...
            />
            <div className={pkg.popular ? 'text-white' : 'text-gray-300'}>
              <p className="font-semibold text-sm">Ondersteuning & Belastingpost</p>
          ...
          <li className="flex items-start">
            ...
            <div className={pkg.popular ? 'text-white' : 'text-gray-300'}>
              <span className="font-semibold text-sm">Salarisadministratie</span>
              {pkg.features.salarisadministratie && (
